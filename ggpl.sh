...
cd poly2tri.python
echo -e "${RED}Installation: larlib:${NC}"
...
echo -e "${BLUE}Premere un tasto per continuare...${NC}"
read
echo -e "${RED}Installation: software aggiuntivo:${NC}"
